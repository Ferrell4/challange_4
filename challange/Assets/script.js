...
function optionSelected(answer){
    ...
    if(userAns == correctAns){
        ...
        // if annswer is incorrect then automatically select the correct answer
...
function showResultBox(){
    ...
    if (userScore > 3){
        ...
        let scoreTag = '<span>and decent job, You got <p>'+ userScore +'</p> out of <p>'+  questions.length +'</p></span>';
        scoreText.innerHTML = scoreTag;
    }else{
        let scoreTag = '<span>and you should study, You got <p>'+ userScore +'</p> out of <p>'+  questions.length +'</p></span>';
        scoreText.innerHTML = scoreTag;
    }
}
...
function startTimer(time){
    ...
    function timer(){
        ...
        if(time < 0){
            ...
            timeOff.textContent = "Out of Time";
